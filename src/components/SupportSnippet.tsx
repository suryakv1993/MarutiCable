      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {cards.map((card, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`glass-card rounded-2xl p-6 sm:p-7 border border-white/10 ${card.border} transition-all flex flex-col justify-between`}
              >
                <div>
                  ...
                  <h3 className="text-lg font-bold text-white mb-1 font-['Manrope']">
                    {card.title}
                  </h3>
                ...
                <div className="mt-6 pt-4 border-t border-white/5">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-white hover:text-[#00E5FF] transition-colors"
                  >
        ...
        <div className="glass-card rounded-2xl p-6 border border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link
              to="/support"
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white/[0.06] hover:bg-white/[0.1] border border-white/10 text-xs font-semibold text-slate-200 transition-all"
            >
