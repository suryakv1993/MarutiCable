    ...
    <div className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="glass-card rounded-3xl p-8 sm:p-10 border border-edge space-y-8 text-ink-soft text-xs sm:text-sm leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            {SITE_CONFIG.serviceTimelines.map((item, idx) => (
              <div key={idx} className="p-4 rounded-2xl bg-app border border-edge space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-ink-strong font-['Manrope']">{item.service}</span>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-ink-faint">
        ...
        <section className="space-y-3">
          ...
          <p>
            For existing active subscribers, renewal orders processed through our online gateway or at our registered office are synchronized to the local authentication servers <strong className="text-ink-strong">within 30 minutes of payment confirmation</strong>. If your router was powered off during recharge, a single power reboot of the ONT will re-establish active authentication immediately.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="p-4 rounded-xl bg-app border border-edge space-y-1 text-xs">
            <div><strong className="text-ink-strong">Maruti Cable Service Delivery Desk</strong></div>
