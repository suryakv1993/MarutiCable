    ...
    <div className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="glass-card rounded-3xl p-8 sm:p-10 border border-white/10 space-y-8 text-slate-300 text-xs sm:text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>
            Broadband subscriptions are prepaid services. Once an optical connection is commissioned, tested, and handed over to the subscriber, or once an existing active plan has been successfully recharged and bandwidth consumed, <strong className="text-white">subscription charges for that active billing period are non-refundable</strong>.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="p-4 rounded-xl bg-[#050816] border border-white/5 space-y-1 text-xs">
            <div><strong className="text-white">Maruti Cable Billing & Refunds Desk</strong></div>
