  ...
  return (
    <div className="py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card rounded-3xl p-7 border border-white/10 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-bold text-white font-['Manrope'] mb-1">Direct Helpline</h3>
              <p className="text-xl font-bold text-white mb-2">{SITE_CONFIG.contact.phone}</p>
          ...
          <div className="glass-card rounded-3xl p-7 border border-white/10 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-bold text-white font-['Manrope'] mb-1">WhatsApp Chat</h3>
              <p className="text-xl font-bold text-white mb-2">Fastest Messaging</p>
              <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="glass-card rounded-3xl p-7 border border-white/10 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-bold text-white font-['Manrope'] mb-1">Email Support</h3>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="glass-card rounded-3xl p-8 sm:p-10 border border-white/15 shadow-2xl">
          <div className="mb-8">
          ...
          {ticketSubmitted ? (
            <div className="p-8 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-center space-y-4">
              ...
              <p className="text-sm text-slate-300 max-w-md mx-auto">
                Thank you, <strong className="text-white">{ticketForm.name}</strong>. Your report regarding <strong className="text-white">{ticketForm.issueType}</strong> at {ticketForm.colony} has been forwarded to our WhatsApp helpline <strong className="text-white">{SITE_CONFIG.contact.phone}</strong>. A local technician will attend to your line promptly.
              </p>
