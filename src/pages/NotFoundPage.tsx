...
export const NotFoundPage: React.FC = () => {
  return (
    <div className="min-h-[70vh] flex items-center justify-center py-16 px-4">
      <div className="glass-card rounded-3xl p-8 sm:p-12 border border-edge text-center max-w-md w-full shadow-2xl">
        ...
        <h1 className="text-2xl sm:text-3xl font-extrabold text-ink-strong mt-1 mb-3 font-['Manrope']">
          Page Not Found
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            to="/coverage"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-slate-100 dark:bg-white/[0.08] hover:bg-slate-200 dark:hover:bg-white/[0.14] text-ink-strong text-xs font-semibold transition-all"
          >
