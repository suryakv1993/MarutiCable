    ...
    <div className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="glass-card rounded-3xl p-8 sm:p-10 border border-white/10 space-y-8 text-slate-300 text-xs sm:text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>
            We do not sell, rent, or trade your personal data to marketing third parties. Data is shared only with our upstream franchise infrastructure partner (<strong className="text-white">{SITE_CONFIG.franchisePartner}</strong>) to establish network routing, and with law enforcement agencies when legally required through appropriate official warrants.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="p-4 rounded-xl bg-[#050816] border border-white/5 space-y-1 text-xs">
            <div><strong className="text-white">Maruti Cable Office Desk</strong></div>
