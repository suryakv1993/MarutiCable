  ...
  return (
    <div className="py-12">
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card rounded-3xl border border-white/10 overflow-x-auto shadow-2xl">
            ...
            <tbody className="divide-y divide-white/5">
              {SITE_CONFIG.fiberPlans.map((plan) => (
                <tr key={plan.id} className="hover:bg-white/[0.02] transition-colors">
                  <td className="p-4 sm:p-5 font-bold text-white font-['Manrope']">
                    {plan.name}
                    {plan.badge && (
                  ...
                  <td className="p-4 sm:p-5 font-bold text-white text-base">
                    ₹{plan.monthlyPrice}<span className="text-xs text-slate-400 font-normal">/mo</span>
                  </td>
                  <td className="p-4 sm:p-5 text-slate-300">Unlimited</td>
                  <td className="p-4 sm:p-5 text-slate-300">1:1 (Upload = Download)</td>
